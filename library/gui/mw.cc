...
/* ------------------------------------------------------------------------- */
void					MW::setInternalActions	( void )
{
...
/* ------------------------------------------------------------------------- */
void				MW::documentWasModified	( void )
{
...
/* ------------------------------------------------------------------------- */
QGraphicsView *		MW::graphicWidget			( void )
{
    return ui.img_view;
}
/* ========================================================================= */
...
/* ------------------------------------------------------------------------- */
void				MW::createRecentFiles		( void )
{
    updateRecentFiles( "" );
}
/* ========================================================================= */
